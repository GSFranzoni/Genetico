...
public class MainScreen extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fitness melhor");
    ...
    public void run() {
        ...
        while(fit>fitMin){
            ...
            this.jLabelFitnessMedio.setText(new DecimalFormat("0.0000000000000000").format(fit));
            this.jLabelFitnessMaior.setText(new DecimalFormat("0.0000000000000000").format(populacao.getMelhor().fitness()));
            try {
                Thread.sleep(50);
    ...
    private void jButtonGetOutputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetOutputActionPerformed
        try {
            ...
            System.out.println(populacao.getMelhor().getGenes());
            this.jTextFieldOutput.setText(new DecimalFormat("0.0000000000").format(Perceptron.getOutput(this.populacao.getMelhor(), input)));
        } 
